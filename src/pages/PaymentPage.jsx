...
import { addCompletedOrder } from "../slice/checkOutSlice";
  ...
  return (
    <div className="bg-[#090D14] w-[393px] text-white flex flex-col items-center">
      {!error && showApplePayAnimation ? (
        <div className="fixed inset-0 left-0 w-full h-full bg-black bg-opacity-60 z-10 flex items-center justify-center">
          <Player
            autoplay
            loop={false}
        ...
        <div className="fixed inset-0 top-0 left-0 w-full h-full bg-black bg-opacity-60 z-10 flex items-center justify-center">
          <Player
            autoplay
            loop={false}
            src={cardAnimation}
        ...
        <>
          ...
          <div className="absolute bottom-12 border-t-[1px] border-[#202938] px-8 mt-6 p-4">
            <CustomButton
