...
const LoginPage = () => {
  ...
  return (
    <div className="bg-[#090D14] bg-cover">
      {/* Header Section */}
      <div className="flex flex-col items-center justify-center bg-[#090D14] text-white p-4">
        <div className="flex items-center justify-between w-[393px] mt-[25px]">
        ...
        {/* Input Section */}
        <div className="flex flex-col justify-center w-[393px] p-6 rounded-lg shadow-md">
        ...
        {/* Divider Section */}
        <div className="relative mt-6 w-[393px] flex items-center">
